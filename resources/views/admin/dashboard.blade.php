                        ...
                        <div x-show="!editing" class="flex items-center justify-between py-1">
                            ...
                            <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                                <x-edit-delete-actions
                                    ...
                                    :delete-route="route('admin.categories.destroy', $cat)"
                                    delete-title="Categorie verwijderen?"
                                    :delete-message="'\'' . $cat->name . '\' wordt permanent verwijderd.'"
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex gap-2 justify-end">
                                        <x-edit-delete-actions
                                            :edit-route="route('admin.menu.edit', $item)"
                                            :delete-route="route('admin.menu.destroy', $item)"
                                            delete-title="Gerecht verwijderen?"
                                            :delete-message="'\'' . $item->name . '\' wordt permanent verwijderd.'"
                                            icon-class="w-4 h-4"
                                            edit-class="text-gray-400 hover:text-grape-500 transition p-1"
                                            delete-class="text-gray-400 hover:text-red-500 transition p-1" />
                                    </div>
                                </td>
                            </tr>
                            @endforeach
