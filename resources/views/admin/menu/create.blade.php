        ...
        <form method="POST" action="{{ route('admin.menu.store') }}" enctype="multipart/form-data"
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <label class="flex items-center gap-1.5 cursor-pointer text-sm">
                        <input type="checkbox" name="allergeens[]" value="{{ $al->id }}"
                               {{ in_array($al->id, old('allergeens', [])) ? 'checked' : '' }}
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="checkbox" name="active" value="1" id="active"
                       ...
                       class="rounded text-grape-500 focus:ring-grape-500">
                <label for="active" class="text-sm text-gray-700">Direct actief (zichtbaar op de site)</label>
            </div>
