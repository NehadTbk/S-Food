    ...
    <div class="mb-6 overflow-x-auto">
        <div class="flex gap-2 min-w-max">
            <button @click="activeCategory = null"
                    :class="activeCategory === null ? 'bg-orange-500 text-white' : 'bg-white text-gray-600 hover:bg-orange-50 border border-gray-200'"
                    class="px-4 py-2 rounded-full text-sm font-medium transition whitespace-nowrap">
                Alles
            </button>
            @foreach($categories as $category)
            <button @click="activeCategory = {{ $category->id }}"
                    :class="activeCategory === {{ $category->id }} ? 'bg-orange-500 text-white' : 'bg-white text-gray-600 hover:bg-orange-50 border border-gray-200'"
                    class="px-4 py-2 rounded-full text-sm font-medium transition whitespace-nowrap">
                {{ $category->name }}
            </button>
            @endforeach
                ...
                <div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex justify-between items-start gap-4">
                            ...
                            <span class="text-orange-500 font-bold text-lg shrink-0">
                        ...
                        <div class="flex items-center gap-4 pt-2">
                            ...
                            <button @click="addToCart(modal.id, modalQty); modal = null"
                                    class="flex-1 bg-orange-500 text-white py-2 rounded-lg text-sm font-medium hover:bg-orange-600 transition">
                                In winkelmandje
                            </button>
                        </div>
                    </div>
